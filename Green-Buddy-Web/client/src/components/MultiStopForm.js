...
const model = [
  ...
  "ENCORE (LUV Engine)",
  "ENCORE (LE2 Engine)",
  "ENCORE AWD (LUV Engine)",
  "ENCORE AWD (LE2 Engine)",
  "XT5",
  "XT5 AWD",
  "COLORADO ZR2 4WD",
  "CRUZE HATCHBACK",
  ...
  "QX30 AWD",
  "F-PACE 35t",
  "F-TYPE R CONVERTIBLE AWD",
  "F-TYPE R COUPE AWD",
  "XE 20d AWD",
  "XE 35t AWD",
  "XF 20d AWD",
  "XF 35t AWD",
  "XJL PORTFOLIO 3.0 AWD",
  "XJR  LWB",
  ...
  "SORENTO AWD FE",
  "SOUL TURBO",
  "AVENTADOR COUPE LP 740",
  "AVENTADOR ROADSTER LP 740",
  ...
  "X3 M40i",
  "CHIRON",
  "ENCORE (SIDI with Stop/Start)",
  "ENCORE AWD (SIDI with Stop/Start)",
  "CRUZE HATCHBACK DIESEL",
  "SILVERADO eASSIST",
  "CHALLENGER GT AWD",
  "CHALLENGER GT AWD FFV",
  ...
  "F-TYPE CONVERTIBLE R-DYNAMIC AWD",
  "F-TYPE COUPE R-DYNAMIC",
  "F-TYPE COUPE R-DYNAMIC AWD",
  "XE 25t AWD",
  "XF 25t AWD",
  "XJ R-SPORT AWD",
  "XJL PORTFOLIO AWD",
  ...
  "CX-5 4WD (Cylinder Deactivation)",
  "MAZDA6 TURBO",
  "AMG C 43 4MATIC",
  ...
  "Mazda3 4-Door",
  "Mazda3 4-Door (SIL)",
  "Mazda3 4-Door (Cylinder Deactivation)",
  "Mazda3 4-Door 4WD",
  "Mazda3 5-Door",
  "Mazda3 5-Door (SIL)",
  "Mazda3 5-Door 4WD",
  ...
  "Voyager (Stop-Start)",
  "Challenger AWD",
  "Challenger Widebody (MDS)",
  "Challenger SRT Hellcat Widebody",
  "Charger Widebody (MDS)",
  ...
  "Discovery Sport P290",
  "Range Rover 5.0 Supercharged LWB",
...
function MultiStopForm(props) {
  ...
  return (
    <div className="bg-gradient-to-t from-green-100 to-white rounded-md shadow-md p-6 w-1/2 absolute z-50 left-1/4 right-1/4 mt-10">
      <h2 className="text-lg font-medium mb-4">Enter Route Details</h2>
      <form className="h-[500px] overflow-auto">
        <div className="mb-4">
          ...
          <input
            type="text"
            id="brand"
            value={form.citiesList}
            onChange={(e) => handleFormFieldChange("citiesList", e)}
        ...
        <div className="mb-4">
          <label htmlFor="v_class" className="block font-medium mb-2">
            Class
          </label>
          <input
            type="text"
            id="v_class"
            value={form.v_class}
            onChange={(e) => handleFormFieldChange("v_class", e)}
            className="w-1/2 border border-gray-300 rounded-md p-2"
            list="v_ass"
          />
          <datalist id="v_ass" size="5">
            {vehicle_class.map((v) => (
              <option key={v} value={v} />
            ))}
          </datalist>
        ...
        <div className="mb-4">
          <label htmlFor="engine_size_l" className="block font-medium mb-2">
          ...
          <input
            ...
            onChange={(e) => handleFormFieldChange("engine_size_l", e)}
            className="w-1/2 border border-gray-300 rounded-md p-2"
          />
        </div>
        <div className="mb-4">
          <label htmlFor="cylinders" className="block font-medium mb-2">
            Cylinders
          </label>
          <input
            type="text"
            ...
            onChange={(e) => handleFormFieldChange("cylinders", e)}
            className="w-1/2 border border-gray-300 rounded-md p-2"
            list="cyrs"
          />
          <datalist id="cyrs" size="5">
            {cyl.map((c) => (
        ...
        <div className="mb-4">
          <label htmlFor="mileage" className="block font-medium mb-2">
            Mileage
          </label>
          <input
            type="number"
